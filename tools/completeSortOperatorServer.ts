...
<style>:root{font:15px system-ui;color:#eee;background:#0c0e11}body{max-width:1050px;margin:auto;padding:24px}fieldset,section{border:1px solid #3b4049;border-radius:9px;padding:16px;margin:12px 0}label{margin:7px;display:inline-block}button,select,input{padding:8px;margin:4px;background:#20242a;color:#eee;border:1px solid #59606b;border-radius:5px}.run{border-color:#a66;color:#ffd5b0}pre{white-space:pre-wrap;max-height:420px;overflow:auto}</style>
